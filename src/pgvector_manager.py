...
class PGVectorManager:
    ...
    def __init__(self):
        ...
        self.database = os.getenv("DB_NAME", "db_rag")
        self.user = os.getenv("DB_USER", "sgadmin")
        self.password = os.getenv("DB_PASSWORD", "sg4dm1n!")
        ...
        try:
            ...
            query = f"""
                SELECT c.id, c.chunk_text, c.format, c.chunk_index,
                       d.filename, d.titulo, d.file_type, d.link,
